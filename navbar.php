...
<!-- <div class="container">
      <section class="recepcion">
        <h1 class="titulo_recepcion">JUNTEMOS NUESTRAS MANOS!</h1>
        <h2 class="subtitulo_recepcion">Entre todos, podemos ayudarnos para dar una mano a quien mas lo necesita.</h2>
